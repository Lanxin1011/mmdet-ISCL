...
from .standard_roi_head2_de import StandardRoIHead2De
from .standard_roi_head2_de_con import StandardRoIHead2DeCon
from .standard_roi_head2_de_tri import StandardRoIHead2DeTri
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead', 'StandardRoIHead2', 'StandardRoIHead2De',
    'StandardRoIHead2DeCon', 'StandardRoIHead2DeTri'
]
