...
class BBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 reg_class_agnostic=False,  # 是否采用class_agnostic(类别不可知)的方式来预测，class_agnostic表示输出bbox时只考虑其是否为前景，后续分类的时候再根据该bbox在网络中的类别得分来分类，也就是说一个框可以对应多个类别
        ...
        print(f'with_cls: {self.with_cls}')  ######
        print(f'reg_class_agnostic: {self.reg_class_agnostic}')  ######
    ...
    def _get_target_single(self, pos_bboxes, neg_bboxes, pos_gt_bboxes,
        ...
        decoded_bbox_targets = pos_bboxes.new_zeros(num_samples, 4)
    ...
    def get_targets(self,
        ...
        # print(pos_gt_bboxes_list)
        pos_gt_labels_list = [res.pos_gt_labels for res in sampling_results]

        labels, label_weights, bbox_targets, bbox_weights = multi_apply(  ###### _
    ...
    def loss(self,
             ...
             bbox_targets,
             bbox_weights,
             # *args,  ###### mayu have multi-parameters, like 'decoded_bbox_targets', use *args to receive
