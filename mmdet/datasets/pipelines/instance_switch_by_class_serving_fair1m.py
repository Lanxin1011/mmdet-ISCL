...
class InstanceSwitchByClassServingFAIR:
    ...
    def __init__(self, 
        ...
        self.cm_len = 9 # if don't consider class 'others', need to uncomment codes in line 196~197
        total_cls_len = 11
