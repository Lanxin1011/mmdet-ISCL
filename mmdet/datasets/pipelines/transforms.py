...
class MixUp:
    ...
    def __call__(self, results):
        ...
        ### test visualization after mixup transformation
        # img = results['img']
        # f_name = results['ori_filename']
        # cv2.imwrite('work_dirs/rebuttal/test_mixup/faster_r50_mixup_ReIS/vis_mixup/' + f_name, img)
        ###
        print('call mixup.')
        return results
...
class RandomAffine:
    ...
    def __call__(self, results):
        ...
        cv2.imwrite('work_dirs/rebuttal/test_mixup/faster_r50_raff_ReIS/vis_raff/'+ results['ori_filename'], img)
